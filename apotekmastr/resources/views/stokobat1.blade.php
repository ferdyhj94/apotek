              ...
              <div class="panel-body">
                <form role="form"  id="formFilter" class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php $urllist = url('daftar-obat');
                      {{ Form::open('statusOption', $optionstatus, isset($status)?$status:"all","id='statusOption' class='form-control' onchange='loadContent(\"".$urllist."\");'" ); ?>
                      <select>
                        <option ></option>
                      </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php echo form_dropdown('tingkatpertandingan', $optiontingkatpertandingan, "all","id='tpOption' class='form-control' onchange='loadContent(\"".$urllist."\");'" ); ?>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php echo form_dropdown('gelar', $optiongelar, "all","id='gelarOption' class='form-control' onchange='loadContent(\"".$urllist."\");'" ); ?>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php echo form_dropdown('fakultas', $optionfakultas, "all","id='fakultasOption' class='form-control' onchange='loadContent(\"".$urllist."\" );'" ); ?>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php echo form_dropdown('tahun', $optiontahun, "all","id='tahunOption' class='form-control' onchange='loadContent(\"".$urllist."\");'" ); ?>
                  </div>
                  </div>
                     ...
                     <div class="col-lg-offset-10 col-md-offset-8 col-sm-offset-7 col-xs-offset-6 col-lg-2 col-md-4 col-sm-5 col-xs-6">
                        <div class="btn-group-justified" role="group">
                          <div class="btn-group" role="group">
                            <button type="button" value="submit"  onclick='loadContent(<?php echo "\"".$urllist."\" "?>);' class="btn btn-primary" id="btn-submit">Tampilkan</button>
                          </div>
